...
from timeparser.data.languages_info import language_order
...
@registry
class Settings:
    """Control and configure default parsing behavior of timeparser.
    ...
    * `CACHE_SIZE_LIMIT`
    ...
    def _get_settings_from_pyfile(cls):
        if not cls._pyfile_data:
            from timeparser_data import settings
