...
import timeparser.data
import timeparser.parser

language_codes = timeparser.data.languages_info.language_order
directives = [
    "%a",
    "%A",
    "%w",
...
date_order = list(timeparser.parser.date_order_chart.keys())
