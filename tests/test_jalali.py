...
from timeparser.calendars.jalali_parser import PersianDate, jalali_parser
...
class TestJalaliCalendar(BaseTestCase):
    ...
    @parameterized.expand(
        [
            param(
                date_string="سه شنبه سوم شهریور ۱۳۹۴", dt=datetime(2015, 8, 25, 0, 0)
            ),
            ...
            param(
                date_string="یکشنبه شانزدهم آذر ۱۳۹۳", dt=datetime(2014, 12, 7, 0, 0)
            ),
            param(
                date_string="دوشنبه دوازدهم آبان ۱۳۹۳", dt=datetime(2014, 11, 3, 0, 0)
            ),
            ...
            param(
                date_string="یکشنبه سوم فروردین ۱۳۹۳", dt=datetime(2014, 3, 23, 0, 0)
            ),
            ...
            param(
                date_string="پنجشنبه بیست و سوم اردیبهشت ۱۳۸۹",
                dt=datetime(2010, 5, 13, 0, 0),
            ),
            param(date_string="جمعه سی ام اسفند ۱۳۸۷", dt=datetime(2009, 3, 20, 0, 0)),
            # dates with time component
            param(
                date_string="پنجشنبه ۲۶ شهريور ۱۳۹۴ ساعت ۹:۳۲",
                dt=datetime(2015, 9, 17, 9, 32),
            ),
            param(
                date_string="دوشنبه ۲۳ شهريور ۱۳۹۴ ساعت ۱۹:۱۱",
                dt=datetime(2015, 9, 14, 19, 11),
            ),
            param(
                date_string="جمعه سی ام اسفند ۱۳۸۷ساعت 19:47",
                dt=datetime(2009, 3, 20, 19, 47),
            ),
            param(
                date_string="شنبه چهاردهم دی ۱۳۹۲ساعت 12:1",
                dt=datetime(2014, 1, 4, 12, 1),
            ),
            param(
