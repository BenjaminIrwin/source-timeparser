...
from timeparser_scripts.order_languages import avoid_languages
from timeparser_scripts.utils import combine_dicts

cldr_date_directory = "../timeparser_data/cldr_language_data/date_translation_data/"
supplementary_directory = "../timeparser_data/supplementary_language_data/"
supplementary_date_directory = (
    "../timeparser_data/supplementary_language_data/date_translation_data/"
)
translation_data_directory = "../timeparser/data/"
date_translation_directory = "../timeparser/data/date_translation_data/"
...
def write_complete_data(in_memory=False):
    ...
    init_text = (
        "from timeparser.data import date_translation_data\n"
